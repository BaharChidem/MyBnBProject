...
//        }
    ...
    public static ArrayList<Listing> search_by_coords() throws SQLException {
        ...
        if(coords.isEmpty()) {
            //System.out.println("No listings found for the provided address.");
            return coords;
        }
...
//        }
    ...
    public static void review_reservations() throws SQLException {
        ...
        if (num == 1) {
            ...
            if(past.isEmpty()){
                System.out.println("---------------------------------");
                System.out.println(" No Past Reservations exist");
                System.out.println("---------------------------------");
            }
            else {
                print_reservation(past);
            ...
            if(hosts.isEmpty()){
                System.out.println("--------------------------------------");
                System.out.println(" No Past Reservations exist to get hosts");
                System.out.println("--------------------------------------");
            }
            else {
                print_users(hosts);
    ...
    public static void review_guest() throws SQLException {
        ...
        if(guests.isEmpty()){
            System.out.println("---------------------------------------");
            System.out.println("No Past reservation data to find guests");
            System.out.println("--------------------------------------");
        }
        else {
            print_users(guests);
